...
Socket::Socket(socket::socket_t fd) : handle_{fd} {}
...
int Socket::setcloseexec() { return socket::setcloseexec(handle_); }

int Socket::setnonblocking() { return socket::setnonblocking(handle_); }
