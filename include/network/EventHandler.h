...
class EventHandler final : public EventObserver {
   ...
   public:
    ...
    EventID id() const override { return id_; }
    ...
    bool isReading() const override { return status_ & kReadEvent; }

    bool isWriting() const override { return status_ & kWriteEvent; }

    void setReadCallback(ReadCallback call) { readCallback_ = call; }

    void setWriteCallback(WriteCallback call) { writeCallback_ = call; }

    void setErrorCallback(ErrorCallback call) { errorCallback_ = call; }
